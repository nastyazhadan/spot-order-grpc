...
const (
	SpotInstrumentService_ViewMarkets_FullMethodName = "/spot.v6.SpotInstrumentService/ViewMarkets"
)
...
var SpotInstrumentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "spot.v6.SpotInstrumentService",
